      ...
      >
        ...
        <style jsx>{`
          ...
          .email :global(button) {
            ...
            background-color: ${this.props.flex ? 'var(--accents-3)' : 'var(--black)'};
          ...
          .email :global(button:hover) {
            ...
            border-color: ${this.props.flex ? 'var(--accents-3)' : 'var(--black)'};
            color: ${this.props.flex ? 'var(--accents-3)' : 'var(--black)'};
            outline: none;
          }
